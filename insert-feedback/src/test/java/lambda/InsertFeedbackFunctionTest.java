...
class InsertFeedbackFunctionTest {
  ...
  private InsertFeedbackFunction function;
  ...
  void setUp() {
    ...
    function = new InsertFeedbackFunction();
    try {
      var field = InsertFeedbackFunction.class.getDeclaredField("dynamoDbClient");
